...
//        Mockito.when(mockUserDetails.getUsername())
//                        .thenReturn("1");
//
//        assertEquals(TRANSACTIONS, service.getAllTransactions(mockUserDetails, null).getTransactions());
//    }
//
//    @Test
...
//        Mockito.when(repository.findAll()).thenReturn(TRANSACTIONS);
//
//        TransactionDataResponse response = service.getAllTransactions(null, INCOME);
//
...
//            service.getAllTransactions(null, "invalidFilter")
//        );
//
